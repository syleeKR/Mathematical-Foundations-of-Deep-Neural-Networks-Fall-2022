...
model_test.conv1[0].weight.data = model.conv1[0].weight * conv1_bn_gamma.reshape(-1,1,1,1) / (conv1_bn_var.reshape(-1,1,1,1)+eps)**0.5
model_test.conv1[0].bias.data = (model.conv1[0].bias-conv1_bn_mean)*conv1_bn_gamma / (conv1_bn_var+eps)**0.5 + conv1_bn_beta

model_test.conv2[0].weight.data = model.conv2[0].weight * conv2_bn_gamma.reshape(-1,1,1,1) / (conv2_bn_var.reshape(-1,1,1,1)+eps)**0.5
model_test.conv2[0].bias.data = (model.conv2[0].bias-conv2_bn_mean)*conv2_bn_gamma / (conv2_bn_var+eps)**0.5 + conv2_bn_beta

model_test.fc1[0].weight.data = model.fc1[0].weight * fc1_bn_gamma.reshape(-1,1) / (fc1_bn_var.reshape(-1,1)+eps)**0.5
model_test.fc1[0].bias.data = (model.fc1[0].bias-fc1_bn_mean)*fc1_bn_gamma / (fc1_bn_var+eps)**0.5 + fc1_bn_beta

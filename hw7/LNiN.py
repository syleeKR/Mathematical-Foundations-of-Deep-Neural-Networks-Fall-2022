    ...
    def copy_weights_from(self, net1):
        with torch.no_grad():
            ...
            for i in range(0,len(self.classifier),2):
                ...
                ####################################################
                if(i==0):
                    self.classifier[i].weight.copy_(net1.classifier[i].weight.view(4096, 256,18,18))
                elif(i==2):
                    self.classifier[i].weight.copy_(net1.classifier[i].weight.view(4096, 4096,1,1))
                else:
                    self.classifier[i].weight.copy_(net1.classifier[i].weight.view(10, 4096,1,1))
